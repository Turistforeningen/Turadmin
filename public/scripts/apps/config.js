requirejs.config({
    ...
    paths: {
        ...
        'datepicker': '/lib/bootstrap-datepicker-1.6.4/js/bootstrap-datepicker',
        'datepicker-lang-no': '/lib/bootstrap-datepicker-1.6.4/locales/bootstrap-datepicker.no.min',
