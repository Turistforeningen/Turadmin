...
define(function (require, exports, module) {
    ...
    var $ = require('jquery'),
        ...
        PictureManager = require('picturemanager'),
        PictureCollection = require('collections/pictures'),
        MapWrapper = require('views/map/wrapper'),
        Poi = require('models/poi'),
        PoiPositioningView = require('views/poi/positioning'),
        PoiFactsView = require('views/poi/facts');
    ...
    return Backbone.View.extend({
        ...
        initialize: function (options) {
            ...
            var pictureManager = new PictureManager({
                ...
                pictures: new PictureCollection(options.picturesData)
            });

            pictureManager.render();
