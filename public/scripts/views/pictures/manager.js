define(function (require, exports, module) {
    ...
    var $ = require('jquery'),
        ...
        PictureView = require('views/pictures/picture-edit');
    ...
    return Backbone.View.extend({
        ...
        appendPicture: function (picture) {
            ...
            this.$('[data-container-for="pictures-manager-all-container"]').append(view.render().el);
        },
...
//         'jquery',
//         'backbone',
//         'text!templates/pics.html'
//     ],
//     function($, Backbone, picsTemplate) {
...
//         initialize: function (options) {
//             console.log('PicView init!');
//         },

//         render: function () {
//             // Using Underscore we can compile our template with data
//             var data = {};
//             var compiledTemplate = _.template(picsTemplate, data);
//             // Append our compiled template to this Views "el"
//             this.$el.append(compiledTemplate);
//         }
